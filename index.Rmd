...
* Basic types 13:00-14:30
  + base
  + dates and times
    + `r xfun::embed_file('exercises-1_intro-R_dataframe.pdf')`
    + `r xfun::embed_file('exercises-1_intro-R_index.pdf')`
    + `r xfun::embed_file('exercises-1_intro-R_lists.pdf')`
    + `r xfun::embed_file('exercises-1_intro-R_logicals.pdf')`
    + `r xfun::embed_file('exercises-1_intro-R_vectors.pdf')`
* Data transformation 15:00-16:30
  + Missing values
    + `r xfun::embed_file('exercises-1_intro-R_NAs.pdf')`
...
* Pre-processing/munging 10:00-12:00
  + base: join, merge, aggregate
    + `r xfun::embed_file('exercises-1_intro-R_binding.pdf')`  
  + tidy data: dplyr
  + regular expression
...
* Plotting 10:00-11:30
  + ggplot2
  + colour themes
    + `r xfun::embed_file('exercises-3_plots_basic.pdf')`
    + `r xfun::embed_file('exercises-ggplot.pdf')`
* Maps 12:00-13:00
